...
def test_create_bounds_element():
    ...
    min_longitude = -8.1
    max_longitude = -2.9
    bounds = gpx._create_bounds_element(
...
def test_create_datetime_element_with_tzinfo():
    ...
    elem = gpx._create_datetime_element(
        namespace="timo", name="birth", value=dt)
...
def test_create_decimal_element():
    elem = gpx._create_decimal_element(
        namespace="timo", name="number", value=-42)
